...
//                s3Client.putObject(new PutObjectRequest(bucket+"/light/image", fileName, inputStream, objectMetadata)
//                        .withCannedAcl(CannedAccessControlList.PublicRead));
//                imgUrlList.add(s3Client.getUrl(bucket+"/light/image", fileName).toString());
//            } catch(IOException e) {
